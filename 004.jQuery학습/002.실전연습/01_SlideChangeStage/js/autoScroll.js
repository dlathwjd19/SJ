...
$(() => { ///////////// jQB //////////////////////
    ...
    /**************************************************** 
        ...
        이유는? 모바일에서 에러가 발생하는 주요 원인으로 지목됨
        본 3가지 중요객체에 대하여 e.prevebtDefault() 또는
        ...
        부모박스로 만들고 이것을 대신 사용하여 막기를 설정함!
        (2) 방법2:
        스크롤바를 보일 필요가 없다면 
        막기를 하지 않고 overflow:hidden 처리하여
        스크롤 자체가 되지 않게 셋팅 후 코딩한다!
        (3) 방법3:
        window, document, body에 passive모드를 설정하는 방법
        -> passive:false로 설정함!
    ...
    $(document).on("mousewheel DOMMouseScroll",
        function (e) {
            ...
            *******************************************/
            ...
            // 변수 = 속성값1 || 속성값2
            // -> 두가지 속성중 undefined가 아닌 값 
            // 즉 true처리가 되는 값이 할당된다!!!
